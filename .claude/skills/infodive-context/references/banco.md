...
**Índices:** `email`, `created_at`, `produto_id`

> Esta coleção é apenas armazenamento. O tratamento comercial (qualificação, follow-up, conversão) é feito em sistema externo dedicado.
