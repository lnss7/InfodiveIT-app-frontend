...
export function GsapMenu({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Auto-close menu after success feedback (2.5 seconds)
      setTimeout(() => {
        onToggle(false);
  ...
  return createPortal(
    <div ref={containerRef} className="gsap-menu-theme">
      ...
      <div className="nav" id="nav">
        ...
        >
          <div className="relative w-full flex flex-col pt-4 pb-16 px-4 md:px-8">
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5 text-left text-gray-900 font-sans">
        ...
        {/* Middle panel — Blue gradient with trust stats */}
        <div className="nav-middle nav-border nav-panel" id="navMiddle">
          <div className="nav-middle-header text-white/70">DIFERENCIAIS INFODIVE</div>
          <div className="nav-middle-card">
            ...
            <div className="nav-middle-info">
              <div className="nav-middle-title text-white">Segurança e Alta Disponibilidade</div>
              <div className="nav-middle-desc text-white/80 text-xs leading-relaxed mt-0.5">
                SLA crítico em 15min e suporte NOC especializado 24/7.
              </div>
            </div>
          </div>
          <div className="nav-middle-actions mt-3">
            <a href="#solutions" onClick={() => onToggle(false)} className="nav-action-btn text-xs font-semibold">
              Ver Soluções
            </a>
          </div>
        </div>
