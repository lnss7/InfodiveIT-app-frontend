...
export const PRODUCTS: Product[] = [
    ...
    diferenciais: [
      {
        ...
        description:
          "Mapeia dados sensíveis em ambientes on-prem e multicloud sem agentes pesados.",
      },
      {
        title: "Análise de risco em tempo real",
        description:
          "Detecta acessos anômalos e tentativas de exfiltração com analytics comportamental.",
      },
      {
        title: "Conformidade contínua",
        description:
          "Relatórios prontos para LGPD, PCI-DSS, SOX e auditorias recorrentes.",
      },
    ],
    casosDeUso: [
      {
        title: "Proteção de dados regulados",
        description:
          "Instituições financeiras e saúde que precisam comprovar conformidade.",
      },
      {
        title: "Auditoria de acessos",
        description:
          "Rastreabilidade completa de quem acessou quais dados e quando.",
      },
      {
        title: "Resposta a incidentes",
        description:
          "Alertas acionáveis integrados ao SOC para conter ameaças rapidamente.",
      },
    ],
    servicos: [
  ...
  },
  {
    ...
    diferenciais: [
      {
        title: "Backups imutáveis",
        description:
          "Cópias à prova de ransomware (WORM) que não podem ser alteradas ou apagadas.",
      },
      {
        title: "Recuperação instantânea",
        description:
          "Restaure VMs, bancos e arquivos em minutos, não em horas.",
      },
      {
        title: "Multicloud nativo",
        description:
          "Proteção consistente em VMware, Hyper-V, AWS, Azure e Microsoft 365.",
      },
    ],
    casosDeUso: [
      {
        ...
        description:
          "Camada imutável que garante recuperação sem pagar resgate.",
      },
      {
        title: "Disaster Recovery",
        description:
          "Failover orquestrado para um site secundário com RTO baixo.",
      },
      {
        title: "Proteção de Microsoft 365",
        description:
          "Backup de e-mails, Teams e SharePoint fora da retenção nativa.",
      },
    ],
    servicos: [
      { nome: "Implementação", icon: Wrench },
    ...
    diferenciais: [
      {
        ...
        description:
          "Plataformas de 1 a 4 sockets para crescer conforme a demanda.",
      },
      {
        title: "Segurança no silício",
        description:
          "Root of Trust e boot verificado protegem desde o firmware.",
      },
      {
        title: "Gestão simplificada",
        description:
          "Automação de provisionamento e telemetria via iDRAC e OpenManage.",
      },
    ],
    casosDeUso: [
      {
        title: "Virtualização densa",
        description:
          "Consolide dezenas de VMs por host com alta disponibilidade.",
      },
      {
        title: "Cargas de IA/ML",
        description: "Configurações com GPU para treinamento e inferência.",
      },
      {
        title: "Edge computing",
        description: "Modelos compactos para filiais e ambientes de borda.",
      },
    ],
    servicos: [
  ...
  },
  {
    ...
    diferenciais: [
      {
        title: "Proteção unificada",
        description:
          "Backup e EDR no mesmo agente, sem conflitos entre ferramentas.",
      },
      {
        title: "Anti-ransomware com IA",
        description:
          "Detecção comportamental que reverte alterações maliciosas.",
      },
      {
        title: "Gestão centralizada",
        description: "Console único para políticas, alertas e recuperação.",
      },
    ],
    casosDeUso: [
      {
        title: "PMEs e filiais",
        description: "Proteção completa sem time de segurança dedicado.",
      },
      {
        title: "Endpoints remotos",
        description: "Backup e defesa de notebooks fora da rede corporativa.",
      },
      {
        title: "Recuperação confiável",
        description: "Restauração validada após incidentes de segurança.",
      },
    ],
    servicos: [
      { nome: "Implementação", icon: Wrench },
    ...
    diferenciais: [
      {
        ...
        description: "Mesma experiência on-prem, em nuvem pública e na borda.",
      },
      {
        title: "Segurança integrada",
        description: "Políticas, RBAC e supply chain seguro por padrão.",
      },
      {
        title: "Produtividade dev",
        description:
          "CI/CD, GitOps e catálogos de serviços prontos para times.",
      },
    ],
    casosDeUso: [
      {
        title: "Modernização de apps",
        description: "Migre monólitos para microsserviços com containers.",
      },
      {
        title: "Plataforma interna",
        description: "Self-service para times de desenvolvimento (IDP).",
      },
      {
        title: "Workloads de IA",
        description: "Orquestração de modelos e pipelines de dados em escala.",
      },
    ],
    servicos: [
  ...
  },
  {
    ...
    diferenciais: [
      {
        title: "Escala global",
        description: "Datacenters em dezenas de regiões com baixa latência.",
      },
      {
        title: "IA e dados",
        description: "Serviços gerenciados de IA, analytics e bancos de dados.",
      },
      {
        title: "Governança de custos",
        description:
          "FinOps e tags para previsibilidade e otimização contínua.",
      },
    ],
    casosDeUso: [
      {
        title: "Migração para a nuvem",
        description: "Lift-and-shift ou modernização de cargas legadas.",
      },
      {
        title: "Ambientes híbridos",
        description: "Integração com datacenter via Azure Arc e ExpressRoute.",
      },
      {
        title: "Plataformas de dados",
        description: "Lakehouse e analytics com Synapse e Fabric.",
      },
    ],
    servicos: [
      { nome: "Migração", icon: RefreshCcw },
  ...
  },
  {
    ...
    diferenciais: [
      {
        title: "Latência previsível",
        description: "Resposta em microssegundos mesmo sob carga intensa.",
      },
      {
        title: "Eficiência por hardware",
        description: "Compressão e dedup sem impacto na performance.",
      },
      {
        title: "Resiliência cibernética",
        description: "Cópias imutáveis e detecção de ransomware no storage.",
      },
    ],
    casosDeUso: [
      {
        title: "Bancos de dados críticos",
        description: "Workloads transacionais que exigem baixa latência.",
      },
      {
        title: "Consolidação de storage",
        description: "Reduza TCO unificando cargas em uma plataforma.",
      },
      {
        title: "Proteção de dados primários",
        description: "Recuperação rápida a partir de cópias imutáveis.",
      },
    ],
    servicos: [
      { nome: "Projeto & Deploy", icon: ServerCog },
  ...
  },
  {
    ...
    diferenciais: [
      {
        title: "Implantação acelerada",
        description: "Appliances pré-validados prontos para produção em horas.",
      },
      {
        title: "Escala linear",
        description: "Adicione nós sem rearquitetar o ambiente.",
      },
      {
        title: "Operação simplificada",
        description: "Gestão unificada de compute, storage e rede.",
      },
    ],
    casosDeUso: [
      {
        title: "Modernização de datacenter",
        description: "Substitua silos por uma stack convergente.",
      },
      {
        title: "VDI",
        description: "Desktops virtuais com performance previsível.",
      },
      {
        title: "Filiais (ROBO)",
        description: "Infraestrutura compacta e gerenciada remotamente.",
      },
    ],
    servicos: [
      { nome: "Projeto & Deploy", icon: ServerCog },
 ...
 *
 * @param slug - Slug do produto (ex.: `"ibm-guardium"`).
 * @returns O produto correspondente, ou `undefined` se não existir.
 *
 * @example
 * const produto = getProductBySlug("ibm-guardium");
 */
...
/**
 * Lista produtos relacionados a um produto: mesma categoria OU mesmo fabricante,
 * excluindo o próprio produto.
 *
 * @param product - Produto base da comparação.
 * @param limit - Máximo de itens retornados. Default: `4`.
 * @returns Lista de produtos relacionados (até `limit`).
 *
 * @example
 * const relacionados = getRelatedProducts(produto, 3);
 */
